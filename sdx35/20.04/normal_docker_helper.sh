...
print_usage()
{
    ...
    echo "NOTE"
    echo "  This container base on ghcr.io/cavli-wireless/sdx35/focal/owrt:latest"
...
__UID=$(id -u $1)
__GID=$(id -g $1)
DOCKER_PRV_NAME=build_sdx35_focal
DOCKER_CONTAINER=${DOCKER_PRV_NAME}_${__USERNAME}
DOCKER_IMG=ghcr.io/cavli-wireless/sdx35/focal/owrt
